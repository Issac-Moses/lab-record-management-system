...
import { Bell, Clock, Shield, MessageSquare, Inbox, Send } from "lucide-react";
...
export default function FacultyNotifications() {
  ...
  const fetchMessages = useCallback(async () => {
    ...
    const result = await getFacultyInboxNotifications(currentDept || null, 30);
    if (result.success) {
      setMessages(
    ...
    <div className="mx-auto max-w-2xl space-y-6">
      ...
      <div>
        <div className="mb-4 flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-slate-500">Broadcast messages to students or other faculty</p>
          </div>
        </div>
      ...
      <div>
        <div className="mb-4 flex items-center gap-3">
          ...
          <div>
            <h2 className="text-lg font-bold text-slate-900">Received Notifications</h2>
            <p className="text-xs text-slate-500">Messages sent to faculty from admin</p>
          </div>
